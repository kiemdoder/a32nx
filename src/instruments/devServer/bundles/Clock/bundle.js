	...
	*/
	...
	const SimVarProvider = ({
	  ...
	  const getKey = (name, unit, varType) => {
	    switch (varType) {
	      default:
	        return "".concat(name, "/").concat(normalizeUnitName(unit));

	      case 1:
	        return "_GLOBAL_".concat(name, "/").concat(normalizeUnitName(unit));

	      case 2:
	        return "_GAME_".concat(name, "/").concat(normalizeUnitName(unit));
	    }
	  };
	  /**
	  ...
	  const retrieve = (name, unit, force, varType) => {
	  ...
	  const register = (name, unit, maxStaleness, varType) => {
	  ...
	  const unregister = (name, unit, maxStaleness, varType) => {
	    const key = getKey(name, unit, varType);
	...
	const Chrono = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("text", {
	    ...
	    y: "60",
	    className: "fontBig",
	    children: ltsTest === 0 ? '88:88' : getDisplayString$1(elapsedTime, running)
	  });
	};
	...
	const Clock = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
	    children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	      ...
	      y: "153",
	      className: "fontBig",
	      children: ltsTest === 0 ? '88:88:' : text1
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: "190",
	      y: "147",
	      className: "fontSmall",
	      children: ltsTest === 0 ? '88' : text2
	    })]
	  });
	};
	...
	const ElapsedTime = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("text", {
	    ...
	    y: "247",
	    className: "fontBig",
	    children: ltsTest === 0 ? '88:88' : getDisplayString(elapsedTime, elapsedKnobPos === 0)
	  });
	};
	...
	const ClockRoot = () => {
	  ...
	  return dcHot1IsPowered ? /*#__PURE__*/jsxRuntime.jsx("svg", {
	    version: "1.1",
	    viewBox: "0 0 256 256",
	    xmlns: "http://www.w3.org/2000/svg",
	    children: /*#__PURE__*/jsxRuntime.jsxs("g", {
	      className: "".concat(phaseOfDay, " ").concat(displayState),
